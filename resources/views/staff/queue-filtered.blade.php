    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0">{{ $title ?? 'Queue' }}</h1>
                    <p class="text-muted">{{ $subtitle ?? 'Queue details' }}</p>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($appointment->queue)
                                            <span class="badge bg-light text-dark fs-6">{{ $appointment->queue->queue_number }}</span>
                                        @else
